...
export class WidgetType {
    ...
    public static readonly STICKERPICKER = new WidgetType(
        "m.stickerpicker",
        "m.stickerpicker",
    );
    public static readonly INTEGRATION_MANAGER = new WidgetType(
    ...
    static fromString(type: string): WidgetType {
        ...
        const known = Object.values(WidgetType).filter(
            (v) => v instanceof WidgetType,
        );
