...
export class VoiceRecordingStore extends AsyncStoreWithClient<IState> {
     ...
     * @param {string} voiceRecordingId The room ID (with optionaly the thread ID if in one) to get the recording in.
     ...
     * @param {string} voiceRecordingId The room ID (with optionaly the thread ID if in one) to start recording in.
     ...
     * @param {string} voiceRecordingId The room ID (with optionaly the thread ID if in one) to dispose of the recording in.
