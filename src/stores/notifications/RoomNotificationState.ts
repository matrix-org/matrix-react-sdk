...
export class RoomNotificationState extends NotificationState implements IDestroyable {
    constructor(public readonly room: Room) {
        ...
        this.room.on(EventTimelineSetEvent.RoomTimeline, this.handleRoomEventUpdate);
    ...
    public destroy(): void {
        ...
        this.room.removeListener(EventTimelineSetEvent.RoomTimeline, this.handleRoomEventUpdate);
