...
export abstract class GenericEchoChamber<
    C extends EchoContext,
    K,
    V,
> extends EventEmitter {
    ...
    protected abstract onClientChanged(
    ...
    public setValue(
        ...
        ctxn.when(TransactionStatus.Pending, () =>
            this.cacheVal(key, targetVal, ctxn),
