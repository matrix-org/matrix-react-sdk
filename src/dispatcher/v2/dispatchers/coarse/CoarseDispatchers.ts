...
export class CoarseDispatchers {
    ...
    private byRoute = new EnhancedMap<CoarseRoute, CoarseDispatcher>();
    ...
    public static get instance(): CoarseDispatchers {
        if (!CoarseDispatchers._instance) {
            CoarseDispatchers._instance = new CoarseDispatchers();
        }
        return CoarseDispatchers._instance;
    }
}
