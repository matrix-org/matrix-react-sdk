    ...
    return (
        <BaseCard header={header} className="mx_RoomSummaryCard" onClose={onClose}>
            <Group title={_t("About")} className="mx_RoomSummaryCard_aboutGroup">
                <Button
                    className="mx_RoomSummaryCard_icon_people mx_RoomSummaryCard_ButtonWithIcon"
                ...
                {pinningEnabled && !isVideoRoom && (
                    <Button
                        className="mx_RoomSummaryCard_icon_pins mx_RoomSummaryCard_ButtonWithIcon"
                ...
                <Button
                    className="mx_RoomSummaryCard_icon_settings mx_RoomSummaryCard_ButtonWithIcon"
