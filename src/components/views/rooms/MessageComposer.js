...
export default class MessageComposer extends React.Component {
    ...
    render() {
        //console.log("WHAT IS TOMBSTONE", this.state.tombstone); // null
        //console.log("CAN SEND MESSAGES STATE", this.state.canSendMessages); // boolean
        //console.log("THIS STATE ME", this.state.me); // Object of room's metadata
