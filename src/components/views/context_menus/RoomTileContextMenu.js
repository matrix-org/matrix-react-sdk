...
const RoomTagOption = ({active, onClick, src, srcSet, label}) => {
    ...
    return (
        <AccessibleButton className={classes} onClick={onClick} aria-pressed={active} aria-label={label}>
...
const NotifOption = ({active, onClick, src, label}) => {
    ...
    return (
        <AccessibleButton className={classes} onClick={onClick} role="radio" aria-checked={active} aria-label={label}>
...
module.exports = createReactClass({
    ...
    _renderNotifMenu: function() {
        return (
            <div className="mx_RoomTileContextMenu" role="radiogroup" aria-label={_t("Notification settings")}>
