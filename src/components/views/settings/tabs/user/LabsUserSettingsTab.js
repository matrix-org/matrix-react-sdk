...
export class LabsSettingToggle extends React.Component {
    ...
    render() {
        ...
        const canChange = SettingsStore.canSetValue(
            this.props.featureId,
            null,
            SettingLevel.DEVICE,
        );
...
export default class LabsUserSettingsTab extends React.Component {
    constructor() {
        ...
        MatrixClientPeg.get()
            .doesServerSupportUnstableFeature("org.matrix.msc2285")
            .then((showHiddenReadReceipts) => {
        ...
        return (
            <div className="mx_SettingsTab mx_LabsUserSettingsTab">
                ...
                <div className="mx_SettingsTab_subsectionText">
                    {_t(
                        "Feeling experimental? Labs are the best way to get things early, " +
