...
export class ExistingEmailAddress extends React.Component<IExistingEmailAddressProps, IExistingEmailAddressState> {
    ...
    public render(): React.ReactNode {
        if (this.state.verifyRemove) {
            return (
                <div className="mx_EmailAddress--existing">
                    <span className="mx_EmailAddress--existing_promptText">
                        {_t("Remove %(email)s?", { email: this.props.email.address })}
                    </span>
                    <AccessibleButton
                        onClick={this.onActuallyRemove}
                        kind="danger_sm"
                        className="mx_EmailAddress--existing_confirmBtn"
                    >
                        {_t("Remove")}
                    </AccessibleButton>
                    <AccessibleButton
        ...
        return (
            <div className="mx_EmailAddress--existing">
                <span className="mx_EmailAddress--existing_email">{this.props.email.address}</span>
