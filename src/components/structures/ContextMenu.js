...
export const ContextMenuButton = ({ label, isExpanded, children, tooltip, ...props }) => {
    const AccessibleButton = sdk.getComponent(tooltip ? 'elements.AccessibleTooltipButton' : 'elements.AccessibleButton');
    return (
