module.exports={
    ...
    "Are you sure you want to leave the room?" : "Tem certeza que deseja sair da sala?",
    ...
    'Either use HTTPS or ' : 'Tanto utilize HTTPS quanto ',
    '😃 Emoji' : '😃 Ícones', 
    'enable unsafe scripts' : 'Habilitar rotinas inseguras',
    ...
    "Export E2E room keys" : "Exportar chave de criptografia ponta-a-ponta (E2E) da sala",
    "Failed to change password. Is your password correct?" : "Falha para modificar a senha, A senha informada está correta?"
    "Failed to leave room" : "Falha na tentiva de deixar a sala",
    "Failed to reject invitation" : "Falha ao rejeitar convite",
    'Failed to send email: ' : 'Falha ao enviar email',
    "Failed to set avatar." : "Falha em definir foto do perfil.",
    'Favourites' : 'Favoritos',
    'Filter room members' : 'Filtrar membros de sala',
    "For security, logging out will delete any end-to-end encryption keys from this browser. If you want to be able to decrypt your conversation history from future Riot sessions, please export your room keys for safe-keeping." : "Por segurança, deslogar irá remover qualquer chave de criptografia ponta-a-ponta deste navegador. Caso deseje descriptografar o histórico das suas conversas em sessões Riot futuras, por favor exporte as chaves da sala para sua garantia.,
    ...
    "Guests can't use labs features. Please register." : "Convidados não podem usar as funcionalidades de laboratório, por gentileza se registre.",
    "Guest users can't upload files. Please register to upload." : "Usuários não podem fazer envio de arquivos. Por favor se cadastre para subir arquivos.",
    "Hangup" : "Desligar",
    ...
    "Send a message (unencrypted)" : "Enviar a mensagem (sem criptografia)",
    "Send an encrypted message…" : "Enviar a mensagem criptografada",
    ...
    "Verification Pending" : "Verificar pendências",
    'Verification' : 'Verificação', 
    'verified' : 'Verificado',
    "Video call" : "Ligação de vídeo",
    "Voice call" : "Ligação de voz",
    'Warning' : 'Alerta',
    "Who would you like to add to this room?" : "Você gostaria de ser adicionado a esta sala?",
