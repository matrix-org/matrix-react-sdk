...
/*
 * Holds the global instance of the `Platform` to use across the codebase
 * (singleton). Looking for an `Platform`? Just look for the `PlatformPeg` on
 * the peg board. "Peg" is the literal meaning of something you hang something
 * on. So you'll find a `Platform` hanging on the `PlatformPeg`.
 *
