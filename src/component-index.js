...
module.exports.components['views.previews.LinkPreviewWidget'] = require('./components/views/previews/LinkPreviewWidget');
module.exports.components['views.previews.OpenGraphPreview'] = require('./components/views/previews/OpenGraphPreview');
module.exports.components['views.previews.YoutubePreview'] = require('./components/views/previews/YoutubePreview');
