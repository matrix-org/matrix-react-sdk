...
module.exports.components['views.messages.GenericEvent'] = require('./components/views/messages/GenericEvent');
...
module.exports.components['views.room_settings.DevSettings'] = require('./components/views/room_settings/DevSettings');
