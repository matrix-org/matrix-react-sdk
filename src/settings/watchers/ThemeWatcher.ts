...
export default class ThemeWatcher {
    ...
    constructor() {
        ...
        this.preferDark = (<any>global).matchMedia(
            "(prefers-color-scheme: dark)",
        );
        this.preferLight = (<any>global).matchMedia(
    ...
    public start() {
        this.themeWatchRef = SettingsStore.watchSetting(
            "theme",
            null,
            this.onChange,
        );
        this.systemThemeWatchRef = SettingsStore.watchSetting(
            "use_system_theme",
            null,
            this.onChange,
        );
    ...
    public recheck(forceTheme?: string) {
        ...
        this.currentTheme =
            forceTheme === undefined ? this.getEffectiveTheme() : forceTheme;
