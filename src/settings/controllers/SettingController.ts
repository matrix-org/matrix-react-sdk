...
export default abstract class SettingController {
     ...
     * @param {SettingLevel} level The level at which the value was requested at.
     ...
     */
    public getValueOverride(level: SettingLevel, roomId: string, calculatedValue: SettingValue<any>, calculatedAtLevel: SettingValue<any>): SettingValue<any> {
     ...
     */
    public onChange(level: SettingLevel, roomId: string, newValue: SettingValue<any>): void {
