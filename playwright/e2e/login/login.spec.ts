...
test.describe("Consent", () => {
    ...
    test.describe("m.login.password", () => {
        ...
        test("logs in with an existing account and lands on the home screen", async ({ page }) => {
            ...
            await expect(page.locator(".mx_ServerPicker_server")).toHaveText(homeserver.baseUrl);
