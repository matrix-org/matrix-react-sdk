...
export class SlidingSyncProxy {
    ...
    async start(homeserver: HomeserverInstance): Promise<ProxyInstance> {
        ...
        const homeserverIp = homeserver.host;
    ...
    async stop(): Promise<void> {
        if (this.instance) throw new Error("Sliding-sync-proxy is already running!");
