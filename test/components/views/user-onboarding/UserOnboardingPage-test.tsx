...
import { filterConsole, renderWithClientContextOptions, stubClient } from "../../../test-utils";
...
describe("UserOnboardingPage", () => {
    const renderComponent = async (): Promise<RenderResult> => {
        const renderResult = render(<UserOnboardingPage />, renderWithClientContextOptions(MatrixClientPeg.safeGet()));
        await act(async () => {
            jest.runAllTimers();
        });
        return renderResult;
