...
import { mkStubRoom, renderWithClientContextOptions, stubClient } from "../../../../../test-utils";
...
describe("RolesRoomSettingsTab", () => {
    ...
    const renderTab = (propRoom: Room = room): RenderResult => {
        return render(<RolesRoomSettingsTab room={propRoom} />, renderWithClientContextOptions(cli));
    };
