...
describe("MemberList", () => {
    ...
    function renderMemberList(enablePresence: boolean): void {
        ...
        for (let i = 0; i < usersPerLevel; i++) {
            ...
            adminUser.user = User.withReEmitterOnClient(adminUser.userId, client);
            ...
            moderatorUser.user = User.withReEmitterOnClient(moderatorUser.userId, client);
            ...
            defaultUser.user = User.withReEmitterOnClient(defaultUser.userId, client);
