...
const ANDROID_EXPECTED_RESULT = [
    ...
    makeDeviceExtendedInfo(DeviceType.Mobile, "Google (Nexus) 5", "Android 7.0"),
    makeDeviceExtendedInfo(DeviceType.Mobile, "Google (Nexus) (5)", "Android 7.0"),
    makeDeviceExtendedInfo(DeviceType.Mobile, "SM-A510F Build/MMB29", "Android 6.0.1"),
    makeDeviceExtendedInfo(DeviceType.Mobile, "SM-G610M Build/NRD90M", "Android 7.0"),
    makeDeviceExtendedInfo(DeviceType.Mobile, undefined, "Android 9", "Chrome", "69"),
...
const IOS_EXPECTED_RESULT = [
    ...
    makeDeviceExtendedInfo(
        DeviceType.Mobile, "iPad Pro (12.9-inch) (3rd generation)", "iOS 15.2",
        "Element", "1.8.21",
    ),
    // using mobile browser
    makeDeviceExtendedInfo(DeviceType.Mobile, undefined, "iPad", "Safari", "8"),
    makeDeviceExtendedInfo(DeviceType.Mobile, undefined, "iPhone", "Safari", "8"),
];
const DESKTOP_UA = [
