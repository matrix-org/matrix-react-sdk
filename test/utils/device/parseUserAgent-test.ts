...
const ANDROID_EXPECTED_RESULT = [
    makeDeviceExtendedInfo(DeviceType.Mobile, "Xiaomi Mi 9T", "Android 11", "Element dbg", "1.5.0-dev"),
    makeDeviceExtendedInfo(DeviceType.Mobile, "Samsung SM-G960F", "Android 6.0.1", "Element", "1.5.0"),
    makeDeviceExtendedInfo(DeviceType.Mobile, "Google Nexus 5", "Android 7.0", "Element", "1.5.0"),
    makeDeviceExtendedInfo(DeviceType.Mobile, "Google (Nexus) 5", "Android 7.0", "Element", "1.5.0"),
    makeDeviceExtendedInfo(DeviceType.Mobile, "Google (Nexus) (5)", "Android 7.0", "Element", "1.5.0"),
    makeDeviceExtendedInfo(DeviceType.Mobile, "SM-A510F Build/MMB29", "Android 6.0.1", "Element", "1.0.0"),
    makeDeviceExtendedInfo(DeviceType.Mobile, "SM-G610M Build/NRD90M", "Android 7.0", "Element", "1.0.0"),
]
...
const IOS_EXPECTED_RESULT = [
    makeDeviceExtendedInfo(DeviceType.Mobile, "iPhone", "iOS 15.2", "Element", "1.8.21"),
    makeDeviceExtendedInfo(DeviceType.Mobile, "iPhone XS Max", "iOS 15.2", "Element", "1.8.21"),
    makeDeviceExtendedInfo(DeviceType.Mobile, "iPad Pro (11-inch)", "iOS 15.2", "Element", "1.8.21"),
...
const DESKTOP_EXPECTED_RESULT = [
    makeDeviceExtendedInfo(DeviceType.Desktop, undefined, "Macintosh", "Electron", "20"),
    makeDeviceExtendedInfo(DeviceType.Desktop, undefined, "Windows NT 10.0", "Electron", "20"),
]
...
const WEB_EXPECTED_RESULT = [
    makeDeviceExtendedInfo(DeviceType.Web, undefined, "Macintosh", "Chrome", "104"),
    makeDeviceExtendedInfo(DeviceType.Web, undefined, "Windows NT 10.0", "Chrome", "104"),
    makeDeviceExtendedInfo(DeviceType.Web, undefined, "Macintosh", "Firefox", "39"),
    makeDeviceExtendedInfo(DeviceType.Web, undefined, "Macintosh", "Safari", "8"),
    makeDeviceExtendedInfo(DeviceType.Web, undefined, "Android 9", "Chrome", "69"),
    makeDeviceExtendedInfo(DeviceType.Web, undefined, "iPad", "Safari", "8"),
    makeDeviceExtendedInfo(DeviceType.Web, undefined, "iPhone", "Safari", "8"),
    makeDeviceExtendedInfo(DeviceType.Web, undefined, "Windows NT 6.0", "Firefox", "40"),
    makeDeviceExtendedInfo(DeviceType.Web, undefined, "Windows NT 10.0", "Edge", "12"),
];
