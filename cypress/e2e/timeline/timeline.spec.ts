...
describe("Timeline", () => {
    ...
    describe("configure room", () => {
        ...
        it("should create and configure a room on IRC layout", () => {
            ...
            cy.get(".mx_IRCLayout").within(() => {
                ...
                // --MessageTimestamp-width = var(--MessageTimestamp_width) = 46px (See: _common.pcss)
                // --icon-width = 14px
                // --right-padding = 5px
                // --name-width = 80px
                // --resizer-width = 15px
    ...
    describe("message displaying", () => {
        ...
        it("should align generic event list summary with messages and emote on IRC layout", () => {
            ...
            //  = var(--name-width) + var(--icon-width) + var(--MessageTimestamp_width) + 2 * var(--right-padding)
            //  = 80 + 14 + 46 + 2 * 5
            //  = 150px
            ...
            // var(--MessageTimestamp_width) should be applied
